<%@ Page Title="Uudiste veebi ilmad" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="uudisedRainon._Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        &nbsp;</p>
    <p>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EmptyDataText="There are no data records to display." Height="107px" Width="536px">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:uudisteBaas2ConnectionString1 %>" DeleteCommand="DELETE FROM [ilm] WHERE [ilm_id] = @ilm_id" InsertCommand="INSERT INTO [ilm] ([kuupaev], [temp], [uudis_id]) VALUES (@kuupaev, @temp, @uudis_id)" SelectCommand="SELECT ilm.kuupaev, ilm.temp, uudised.uudiseTeema, uudised.kirjeldus FROM ilm INNER JOIN uudised ON ilm.uudis_id = uudised.uudis_id" UpdateCommand="UPDATE [ilm] SET [kuupaev] = @kuupaev, [temp] = @temp, [uudis_id] = @uudis_id WHERE [ilm_id] = @ilm_id">
            <DeleteParameters>
